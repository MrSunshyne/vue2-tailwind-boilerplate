            ...
            >
              <div class="px-2 flex items-center lg:px-0">
                ...
                <div class="hidden lg:block lg:ml-6 lg:space-x-4">
                  <div class="flex">
                    <a
                      href="#"
                      class="rounded-md py-2 px-3 bg-black bg-opacity-25 text-sm leading-5 font-medium text-white focus:outline-none focus:bg-light-blue-800 transition duration-150 ease-in-out"
                      aria-current="page"
                      >Dashboard</a
                    >
                    ...
                    <a
                      href="#"
                      class="rounded-md py-2 px-3 text-sm leading-5 font-medium text-white hover:bg-light-blue-800 focus:outline-none focus:bg-light-blue-800 transition duration-150 ease-in-out"
                      >Jobs</a
                    >
              ...
              >
                <div class="max-w-lg w-full lg:max-w-xs">
                  ...
                  >
                    ...
                    <input
                      id="search"
                      class="block w-full bg-light-blue-700 bg-opacity-50 py-2 pl-10 pr-3 border border-transparent rounded-md leading-5 placeholder-light-blue-100 focus:outline-none focus:bg-white focus:placeholder-gray-500 focus:text-gray-900 sm:text-sm transition duration-150 ease-in-out"
                      placeholder="Search"
                      type="search"
                    />
                  </div>
              ...
              <div class="hidden lg:block lg:ml-4">
                <div class="flex items-center">
                  <button
                    class="flex-shrink-0 border-2 border-transparent rounded-full p-1 text-light-blue-200 hover:bg-light-blue-800 hover:text-white focus:outline-none focus:text-white focus:bg-light-blue-800 transition duration-150 ease-in-out"
                  >
      ...
      -->
          <div class="bg-light-blue-900 hidden lg:hidden">
            <div class="pt-2 pb-3 px-2 space-y-1">
              <a
                href="#"
                class="block rounded-md py-2 px-3 bg-black bg-opacity-25 text-base font-medium text-white focus:outline-none focus:text-white focus:bg-light-blue-800 transition duration-150 ease-in-out"
                >Dashboard</a
              >

              <a
                href="#"
                class="block rounded-md py-2 px-3 text-base font-medium text-white hover:text-white hover:bg-light-blue-800 focus:outline-none focus:text-white focus:bg-light-blue-800 transition duration-150 ease-in-out"
                >Jobs</a
              >
            ...
            <div class="pt-4 pb-3 border-t border-light-blue-800">
              <div class="flex items-center px-4">
                ...
                <div class="ml-3">
                  ...
                  <div
                    class="text-sm font-medium leading-5 text-light-blue-200"
                  >
                    debbielewis@example.com
                  </div>
                </div>
                <button
                  class="ml-auto flex-shrink-0 border-2 border-transparent rounded-full p-1 text-light-blue-200 hover:bg-light-blue-800 hover:text-white focus:outline-none focus:text-white focus:bg-light-blue-700 transition duration-150 ease-in-out"
                >
              ...
              <div class="mt-3 px-2">
                <a
                  href="#"
                  class="block rounded-md py-2 px-3 text-base font-medium text-light-blue-200 hover:text-white hover:bg-light-blue-800 focus:outline-none focus:text-white focus:bg-light-blue-800 transition duration-150 ease-in-out"
                  >Your Profile</a
                >
            ...
            >
              <aside class="py-6 lg:col-span-3">
                <nav>
                  <a
                    href="#"
                    class="group bg-teal-50 border-l-4 border-teal-500 px-3 py-2 flex items-center text-sm leading-5 font-medium text-teal-700 hover:bg-teal-50 hover:text-teal-700 focus:outline-none focus:bg-teal-100 focus:text-teal-700 transition ease-in-out duration-150"
                    aria-current="page"
                  >
                    <!-- Heroicon name: user-circle -->
                    <svg
                      class="flex-shrink-0 -ml-1 mr-3 h-6 w-6 text-teal-500 group-hover:text-teal-500 group-focus:text-teal-600 transition ease-in-out duration-150"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                  ...
                  <a
                    href="#"
                    class="group mt-1 border-l-4 border-transparent px-3 py-2 flex items-center text-sm leading-5 font-medium text-gray-900 hover:bg-gray-50 hover:text-gray-900 focus:outline-none focus:bg-gray-50 focus:text-gray-900 transition ease-in-out duration-150"
                  >
                    <!-- Heroicon name: cog -->
                    <svg
                ...
                <div class="py-6 px-4 space-y-6 sm:p-6 lg:pb-8">
                  ...
                  >
                    <div class="flex-grow space-y-6">
                      <div class="space-y-1">
                        ...
                        <div class="rounded-md shadow-sm flex">
                          ...
                          <input
                            id="username"
                            class="form-input flex-grow block w-full min-w-0 rounded-none rounded-r-md transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                            value="lisamarie"
                          />
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <div class="lg:hidden">
                        <div class="flex items-center">
                          ...
                          <div class="ml-5 rounded-md shadow-sm">
                            <div
                              class="group relative border border-gray-300 rounded-md py-2 px-3 flex items-center justify-center focus-within:border-blue-300 focus-within:shadow-outline-blue focus-within:text-gray-900 transition duration-150 ease-in-out"
                            >
                              <label
                                for="user_photo"
                                class="relative text-sm leading-4 font-medium text-gray-700 group-hover:text-gray-500 transition duration-150 ease-in-out pointer-events-none"
                              >
                                <span>Change</span>
                      ...
                      <div
                        class="hidden relative rounded-full overflow-hidden lg:block transition duration-150 ease-in-out"
                      >
                        <img
                        ...
                        />
                        <label
                          class="absolute inset-0 w-full h-full bg-black bg-opacity-75 flex items-center justify-center text-sm leading-5 font-medium text-white opacity-0 hover:opacity-100 focus-within:opacity-100 transition duration-150 ease-in-out"
                        >
                          <span>Change</span>
                          <span class="sr-only"> user photo</span>
                          <input
                ...
                <div class="pt-6 space-y-4 divide-y divide-gray-200">
                  <div class="px-4 space-y-2 sm:px-6">
                    ...
                    <ul class="divide-y divide-gray-200">
                      <li
                        class="py-4 flex items-center justify-between space-x-4"
                      >
                  ...
                  <div class="py-4 px-4 flex justify-end space-x-5 sm:px-6">
                    <div class="inline-flex rounded-md shadow-sm">
                      <button
                        type="button"
                        class="bg-white border border-gray-300 rounded-md py-2 px-4 inline-flex justify-center text-sm leading-5 font-medium text-gray-700 hover:text-gray-500 focus:outline-none focus:border-light-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800 transition duration-150 ease-in-out"
                      >
                        Cancel
                      </button>
                    </div>
                    <div class="inline-flex rounded-md shadow-sm">
                      <button
                        type="submit"
                        class="bg-light-blue-700 border border-transparent rounded-md py-2 px-4 inline-flex justify-center text-sm leading-5 font-medium text-white hover:bg-light-blue-600 focus:outline-none focus:border-light-blue-800 focus:shadow-outline-blue active:bg-light-blue-800 transition duration-150 ease-in-out"
                      >
                        Save
                      </button>
                    </div>
